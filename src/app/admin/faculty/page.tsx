...
export default function AdminFacultyPage() {
  ...
  const [modalDept, setModalDept] = useState("Computer Science");

  const filteredFaculty = MOCK_FACULTY.filter(faculty => 
    (deptFilter === "All Departments" || faculty.department === deptFilter) &&
      ...
      <div className="glass-card p-3 rounded-2xl flex flex-col sm:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 w-full sm:w-auto">
          <CustomDropdown 
            ...
            value={deptFilter}
            options={["All Departments", "Computer Science", "Mechanical Engg.", "Electrical Engg."]}
            ...
            <div className="p-6 flex flex-col gap-4 overflow-y-auto custom-scrollbar">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <CustomDropdown 
                    value={modalDept}
                    options={["Computer Science", "Mechanical Engg.", "Electrical Engg."]}
